...
const Sidebar: React.FC<SidebarProps> = ({ className }) => {
  ...
  return (
    <aside className={cn(
      // 👇 IMPORTANT FIX: 'right-0' and 'border-l' for Arabic RTL Layout
      "fixed right-0 top-0 h-full w-64 bg-sidebar border-l border-sidebar-border flex flex-col z-50 transition-all duration-300",
      className
    )}>
      {/* Logo Section */}
      ...
      <div className="p-4 border-t border-sidebar-border">
        <div className="mb-3 px-4">
          ...
          {/* 'dir="ltr"' forces email to display correctly (user@email.com) even in Arabic mode */}
